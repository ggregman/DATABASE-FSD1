...
CREATE TABLE `classifica` (
  ...
  KEY `idx_stagione` (`stagione` DESC),
...
CREATE TABLE `partita` (
  ...
  KEY `idx_data_partita` (`stagione` DESC,`data_partita` DESC),
...
CREATE TABLE `statistiche` (
  ...
  KEY `idx_stagione_id_partita` (`stagione` DESC,`id_partita`),
...
-- Dump completed on 2022-04-20 14:21:43
