...
CREATE TABLE `tbl_docente` (
  ...
  KEY `IDX_COGNOME_NOME` (`cognome`,`nome`) /*!80000 INVISIBLE */
...
CREATE TABLE `tbl_firma` (
  ...
  KEY `IDX_ID_CORSO_DATA` (`data` DESC,`ID_corso`),
  KEY `IDX_COGNOME_NOME` (`CF_studente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_lezione` (
  ...
  `orario_termine` time NOT NULL,
  `CF_docente` char(16) NOT NULL,
  `materia` varchar(100) DEFAULT NULL,
  `argomento` varchar(100) DEFAULT NULL,
  `tipologia` enum('TEORIA','ESERCITAZIONE','ACCOMPAGNAMENTO','ORIENTAMENTO') DEFAULT NULL,
  `ID_corso` char(10) NOT NULL,
  PRIMARY KEY (`data`,`orario_inizio`,`orario_termine`,`CF_docente`),
  KEY `IDX_MATERIA` (`materia`),
  KEY `IDX_ID_CORSO_DATA` (`data` DESC,`ID_corso`) /*!80000 INVISIBLE */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_presenza` (
  ...
  UNIQUE KEY `IDX_DATA_ID_CORSO` (`ID_corso`,`data` DESC) /*!80000 INVISIBLE */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_registro` (
  ...
  UNIQUE KEY `IDX_ID_CORSO_CLASSE` (`ID_corso`,`classe`),
...
-- Dump completed on 2022-03-09 17:56:40
